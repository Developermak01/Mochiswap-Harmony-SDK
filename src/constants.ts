...
export const FACTORY_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_MAINNET]: '0xAdeC65AB2A5e5de999065Ee593672D1f85F8Dd97',
  [ChainId.HARMONY_TESTNET]: '0x0000000000000000000000000000000000000001'
}

export const INIT_CODE_HASH = '0xb17f9b8e0996e3824c91decc95fc80cd91a7a9addfd9f1990c8a8e0807337ce4'
